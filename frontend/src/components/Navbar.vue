          ...
          <div class="w-full h-20 px-6 bg-gray-100 border-b flex items-center justify-between">
            ...
            <div class="flex">
              ...
              <div class="relative text-gray-600">
                <input type="search" name="serch" placeholder="搜索你想看的帖子。。" class="bg-white h-10 w-full xl:w-64 px-5 rounded-lg border text-sm focus:outline-none">
            ...
            <div class="flex items-center relative">
              ...
              <img src="../../public/resources/logo.webp" class="w-12 h-12 rounded-full shadow-lg" @click="dropDownOpen = !dropDownOpen">
            </div>
