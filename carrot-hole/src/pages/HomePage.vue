<template>
    <div class="top-box">
        <div class="white-top-box-title">Carrot Hole</div>
        <div class="top-box-title">Carrot Hole</div>
    </div>
    <div class="white">
